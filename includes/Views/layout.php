        ...
        <div class="container">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="<?php echo BASE_URL; ?>vote">投票概览</a></li>
                    <?php if (isset($userModel) && $userModel->isLoggedIn()): ?>
                        <?php if ($userModel->hasPermission(1)): ?>
                            <li><a href="<?php echo BASE_URL; ?>admin/votes">投票管理</a></li>
                        <?php endif; ?>
                        <?php if ($userModel->hasPermission(1)): ?>
                            <li><a href="<?php echo BASE_URL; ?>admin/banlist">禁卡表整理</a></li>
                        <?php endif; ?>
                        <li class="user-info">
                    ...
                    <?php else: ?>
                        <li><a href="<?php echo BASE_URL; ?>admin/login">管理员登录</a></li>
                    <?php endif; ?>
                </ul>
            </nav>
        </div>
